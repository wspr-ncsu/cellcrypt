 ...
 *
 *  Modified by thevirg for cellular_crypto_analysis Project
 */
...
where
  ...
  // Only include files in Core
  and (fileIsCoreMember(base.getFile()) and fileIsCoreMember(rhs.getFile()))
select w as finding, 
"InsecureSkipVerify should not be used in production code.",
w.getRhs().asExpr().getLocation().toString() as location,
"Location"
